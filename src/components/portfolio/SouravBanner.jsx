...
const SouravBanner = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center py-1 md:pt-8 md:ml-12 lg:text-left lg:w-1/2 z-10 relative">
        <motion.div
      ...
      <div className="flex justify-center lg:w-1/2 z-10 relative py-4">
        ...
        <div className="absolute w-full h-3/5 md:h-2/3 border-8 border-cyan-400/30 rounded-full animate-spin-slow"></div>
      </div>
